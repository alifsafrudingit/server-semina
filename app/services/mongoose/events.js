...
const createEvents = async (req) => {
    ...
    const checkName = await Events.findOne({ title });

    if (checkName) throw new BadRequestError(`Judul acara ${title} sudah terdaftar`);
...
const updateEvents = async (req) => {
    ...
    if (check) throw new BadRequestError(`Judul acara ${title} sudah terdaftar`);
